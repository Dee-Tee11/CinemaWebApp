...
import AddFriendPopup from './AddFriend'; // Ajuste o caminho conforme necessário
...
const Sidebar: React.FC<SidebarProps> = ({ onSettingsClick, onProfileClick, onExploreClick }) => {
