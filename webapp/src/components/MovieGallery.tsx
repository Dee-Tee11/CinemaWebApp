        ...
        {allMovies.map((movie, index) => (
          <div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.border = "1px solid rgba(220, 38, 38, 0.6)";
            ...
            >
              ...
              >
                ...
                >
                  <Play
                    size={28}
                    fill="currentColor"
                    style={{ color: "#060010", marginLeft: "4px" }}
                  />
                </div>
              </div>
              ...
              >
                <Eye
                  ...
                  style={{
                    color: movieStates[movie.id].watched ? "#fff" : "#bbb",
                    cursor: "pointer",
                  }}
                />
              </div>
              ...
              >
                <ThumbsUp
                  ...
                  style={{
                    color: movieStates[movie.id].liked ? "#fbbf24" : "#fff",
                    cursor: "pointer",
                  }}
                ...
                <ThumbsDown
                  ...
                  style={{
                    color: movieStates[movie.id].disliked ? "#ff4444" : "#fff",
                    cursor: "pointer",
                  }}
                ...
                <Heart
                  ...
                  style={{
                    color: movieStates[movie.id].favorited ? "#ff69b4" : "#fff",
                    cursor: "pointer",
                  }}
